...
- **In progress:** compact the saved-match start menu without flattening its visual hierarchy: the primary modes retain emphasis, inactive modes and secondary actions become quieter, every phone target remains at least 44 px, and short desktops gain an overflow regression gate ([#79](https://github.com/MetinGames/Long-Narde/issues/79)).
