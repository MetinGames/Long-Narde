...
10. **In progress — [#13](https://github.com/MetinGames/Long-Narde/issues/13):** the 2026-08-04 desktop-Chrome cycle is fixing the game-over restart blocker, bot-move readability, optional point numbers, centre-hinge fit, icon-only fullscreen, compact Quick Bear-Off help, start-card hover, and collected-checker presentation without changing Long Narde rules.
