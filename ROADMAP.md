...
8. **In progress — [#11](https://github.com/MetinGames/Long-Narde/issues/11):** the deterministic baseline, profiling, request-scoped cache, opponent-aware fixtures, and fixed 16-seed/32-match validation are merged through [#34](https://github.com/MetinGames/Long-Narde/pull/34); the expanded sample records a 27–5 result versus the 20–12 control, with additional real-match fixtures next.
