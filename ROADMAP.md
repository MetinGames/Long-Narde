...
- **320 Node tests and 28 executed Playwright checks passing as of 2026-08-03** (50-case browser/device matrix with 22 intentional project skips).
...
8. **In progress — [#11](https://github.com/MetinGames/Long-Narde/issues/11):** the deterministic Champion-versus-Master baseline is merged; [#30](https://github.com/MetinGames/Long-Narde/pull/30) profiles the repeatable double-four outlier before any rule-analysis optimization or Web Worker decision.
