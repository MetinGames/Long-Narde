...
9. **Parallel support — [#8](https://github.com/MetinGames/Long-Narde/issues/8) and completed [#6](https://github.com/MetinGames/Long-Narde/issues/6):** project metadata remains queued; merged [#36](https://github.com/MetinGames/Long-Narde/pull/36) records the complete 49-branch inventory with 44 exact cleanup candidates, one active branch, and four preserved for manual review. No branch has been deleted.
