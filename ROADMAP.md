...
- **335 Node tests and 28 executed Playwright checks passing as of 2026-08-04** (50-case browser/device matrix with 22 intentional project skips).
...
8. **In progress — [#11](https://github.com/MetinGames/Long-Narde/issues/11):** the deterministic baseline, profiling, request-scoped cache, opponent-aware fixtures, and fixed 16-seed/32-match validation are merged through [#34](https://github.com/MetinGames/Long-Narde/pull/34); [#35](https://github.com/MetinGames/Long-Narde/pull/35) corrects a shared player-two evaluation/reporting defect and records 31–1 versus a corrected 26–6 control, with additional real-match fixtures next.
