...
- **350 Node tests and 34 executed Playwright checks passing as of 2026-08-04** (60-case browser/device matrix with 26 intentional project skips).

## Current gaps and risks

- `app.js` is 1,449 lines after the Issue #13 controller wiring; `engine/renderer.js` is 1,195 lines and `style.css` remains 3,543 lines. The new 152-line real-device presentation layer and 116-line point-number controller live in focused files rather than growing the red-zone stylesheet; further extraction remains evidence-driven.
...
10. **In progress — [#13](https://github.com/MetinGames/Long-Narde/issues/13):** the desktop-Chrome cycle is complete through [#40](https://github.com/MetinGames/Long-Narde/pull/40), including restart recovery, silent visual bot feedback, optional point numbers, centre-hinge fit, icon-only fullscreen, compact Quick Bear-Off help, start-card hover, collected-checker presentation, responsive controls, and coherent PWA delivery. Physical iPhone, Android, and tablet validation remains open without changing Long Narde rules.
...
- **In progress:** polish onboarding, game-over restart, bot-move visibility, collected-checker feel, board-label density, fullscreen controls, touch targets, and accessibility; validate the release gate on real devices ([#13](https://github.com/MetinGames/Long-Narde/issues/13)).
