...
const translations = {
    ...
    ru: {
        ...
        'stats.bestWinMoves': 'Лучшая победа по ходам',
        'stats.normalLosses': 'Обычные поражения',
        'stats.timeoutLosses': 'Поражения по времени',
        'stats.empty': 'Пока нет завершённых матчей.',
        'stats.noBestWin': 'Пока нет',
